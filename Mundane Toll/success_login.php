...
<section>
	<div class="log_img">
		<br> <br><br>
		<h2 style="color:white; padding-left:350px;">You have successfully updated your password.You can login now with your new Password</h2>
		...
		<div class="box1">
		  ...
		  <form name="login" method="post" action="">
			...
			<div class="login">
				...
				<i class="fa fa-user icon"  style="color:white;"></i><label><b style="color:white;">  Username</b> </label>
		  ...
		  <p style="color:white; padding-left:70px; ">
			New to our website? <a style="color:white; text-decoration: none;" href="registration.php"><b>Sign Up</b></a>
		  </p>
		</div>
	</div>
</section>
